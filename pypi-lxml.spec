...
Source0  : https://files.pythonhosted.org/packages/63/f7/ffbb6d2eb67b80a45b8a0834baa5557a14a5ffce0979439e7cd7f0c4055b/lxml-5.2.2.tar.gz
...
%prep
%setup -q -n lxml-5.2.2
cd %{_builddir}/lxml-5.2.2
pushd ..
cp -a lxml-5.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715874491
