...
Source0  : https://files.pythonhosted.org/packages/76/3d/14e82fc7c8fb1b7761f7e748fd47e2ec8276d137b6acfe5a4bb73853e08f/lxml-5.4.0.tar.gz
...
%prep
%setup -q -n lxml-5.4.0
cd %{_builddir}/lxml-5.4.0
pushd ..
cp -a lxml-5.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745418378
