...
Source0  : https://files.pythonhosted.org/packages/c5/ed/60eb6fa2923602fba988d9ca7c5cdbd7cf25faa795162ed538b527a35411/lxml-6.0.0.tar.gz
...
%prep
%setup -q -n lxml-6.0.0
cd %{_builddir}/lxml-6.0.0
pushd ..
cp -a lxml-6.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750959722
