...
Source0  : https://files.pythonhosted.org/packages/ef/f6/c15ca8e5646e937c148e147244817672cf920b56ac0bf2cc1512ae674be8/lxml-5.3.1.tar.gz
...
%prep
%setup -q -n lxml-5.3.1
cd %{_builddir}/lxml-5.3.1
pushd ..
cp -a lxml-5.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739205802
